...
extension NewProductFirstStepV{
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.rx.notification(Notification.Name.UIKeyboardWillShow).subscribe(onNext:{ notification in
            self.explanationLabelBottomConstraint.constant = (notification.userInfo![UIKeyboardFrameEndUserInfoKey] as! NSValue).cgRectValue.height + self.explanationLabelBottomConstraint.constant
